  ...
  return (
    <div className="h-auto overflow-hidden pb-28">
      ...
      <div className="fixed bottom-4 left-0 right-0 z-40 pointer-events-none flex justify-center px-4">
        <div className="w-full max-w-3xl bg-white/95 backdrop-blur border border-gray-200 shadow-[0_-8px_24px_rgba(0,0,0,0.12)] rounded-xl px-4 py-3 pointer-events-auto">
          <button
            onClick={handleNext}
            disabled={!state.selectedService}
            className={`w-full sm:w-auto max-w-full sm:max-w-[260px]
