    ...
    <div className="max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 md:p-8">
        ...
        <div className="fixed bottom-4 left-0 right-0 z-40 pointer-events-none flex justify-center px-4">
          <div className="w-full max-w-4xl bg-white/95 backdrop-blur border border-gray-200 shadow-[0_-8px_24px_rgba(0,0,0,0.12)] rounded-xl px-4 py-4 pointer-events-auto flex justify-between items-center gap-3">
            <button
              type="button"
              onClick={onBack}
